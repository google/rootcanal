...
class Test(ControllerTest):
    ...
    async def test(self):
        ...
        await self.steps_3_12(
            peer_address=random_peer_address,
    ...
    async def steps_3_12(
        self,
        peer_address: Address,
        peer_address_type: ll.AddressType,
        scan_response_data: List[int],
    ):
        ...
        invalid_peer_address_type = (
            ll.AddressType.PUBLIC
            if peer_address_type == ll.AddressType.RANDOM
            else ll.AddressType.RANDOM
        )
