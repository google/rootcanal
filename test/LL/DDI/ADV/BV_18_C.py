...
class Test(ControllerTest):
    ...
    async def steps_3_12(self, peer_address: Address, peer_address_type: ll.AddressType,
        ...
        invalid_peer_address_type = (ll.AddressType.PUBLIC if peer_address_type
                                     == ll.AddressType.RANDOM else ll.AddressType.RANDOM)
