...
class Test(ControllerTest):
    ...
    async def test(self):
        ...
        await self.steps_4_14(
            peer_address=public_peer_address, peer_address_type=ll.AddressType.PUBLIC
        )
        ...
        await self.steps_4_14(
            peer_address=random_peer_address, peer_address_type=ll.AddressType.RANDOM
        )
        ...
        await self.steps_24_29(
            peer_address=invalid_peer_address, peer_address_type=ll.AddressType.PUBLIC
        )
    ...
    async def steps_4_14(
        self, peer_address: Address, peer_address_type: ll.AddressType
    ):
        ...
        invalid_peer_address = Address(
            [
                peer_address.address[0] ^ 0xFF,
                peer_address.address[1],
                peer_address.address[2],
                peer_address.address[3],
                peer_address.address[4],
                peer_address.address[5],
            ]
        )
        ...
        invalid_peer_address_type = (
            ll.AddressType.RANDOM
            if peer_address_type == ll.AddressType.PUBLIC
            else ll.AddressType.PUBLIC
        )
