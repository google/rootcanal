    ...
    async def test(self):
        ...
        controller.send_cmd(
            hci.LePeriodicAdvertisingCreateSync(
                options=hci.PeriodicAdvertisingOptions(
        ...
        for n in range(3):
            ...
            advertising_data = [
                random.randint(1, 254) for n in range(advertising_data_length)
            ]
            ...
            num_fragments = (
                math.ceil(advertising_data_length / max_fragment_length) or 1
            )
